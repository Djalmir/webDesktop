...
style.textContent = /*css*/`
	...
	form#googleSearch .inputWrapper {
		margin: 0;
...
template.innerHTML = /*html*/`
	<div id="desktop" z-onclick="rmFolderFocus">
		<form id="googleSearch" class="draggable widget" action="javascript:void(0)" z-onsubmit="submitGoogleSearch"><!--z-onclick="setFocus"-->
			<label class="inputWrapper">
				<input type="search" placeholder="#" z-model="googleSearch">
				<b>Pesquisa Google</b>
			</label>
		</form>
...
export default class Desktop extends HTMLElement {
	constructor() {
		...
		this.setBackgroundImage = () => {
			...
			document.body.style.backgroundColor = "var(--darkgray3)"
		...
		this.submitGoogleSearch = () => {
			if (this.googleSearch.trim())
